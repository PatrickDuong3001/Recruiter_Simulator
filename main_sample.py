...
######################################### game operations #############################################
pygame.init()
pygame.display.set_caption('Family Present')  #set the title for the game
...
###home screen setup
intro_active = True
text_font_menu = pygame.font.Font("data/letter_font.ttf",15)
menu = pygame.image.load("data/grass.JPG").convert_alpha()
couple = pygame.image.load("data/couple.png").convert_alpha()
text_1 = text_font.render("Press Q to view instructions",False,"Red")
text_2 = text_font.render("Press W to start game",False,"Red")
text_3 = text_font_menu.render("Mom",False,"Blue")
text_4 = text_font_menu.render("Dad",False,"Blue")
...
text_title_end_message = text_font_title_end.render("HAPPY FAMILY!",False,"Pink")
text_title_end_message_2 = text_font_end_message.render("Dad finally rescued Mom",False,"Magenta")
action_end = pygame.image.load("data/family.png").convert_alpha()
background_end = pygame.image.load("data/mountain.jpg").convert_alpha() 
go_back = go_back_font.render("Press A to go back to Menu",False,"Yellow")
end_screen = False
...
while run: #to keep the game going, we have to put all functions inside the while loop (game loop)
    while intro_active:
        ...
        screen.blit(text_3,(285,215))
        screen.blit(text_4,(470,215))
        screen.blit(couple,(300,180))
        pygame.display.flip()
    ...
    while end_screen:
        ...
        #end screen initiate
        end_score = go_back_font.render(f"Total Score: {score}",False,"Yellow")
        ...
        screen.blit(action_end,(175,120))
