...
skills = ["Docker","SQL","AWS","Android","Java","JavaScript","PHP","Python","HTML","VHDL","C/C++","CSS","MongoDB","React","Git","Jenkins","Selenium","MATLAB","Pytest","Redmine","Jira","Bootstrap","Bamboo","NoSQL","Azure","Research","WordPress"]
